...
📫 [shreyasnair1998@gmail.com](mailto:shreyasnair1998@gmail.com) · 💼 [LinkedIn](https://www.linkedin.com/in/psshreyasnair/)

---

### 🛠️ Tools & Tech

`Python` `SQL` `Cypher (Neo4j)` `Power BI` `pandas` `scikit-learn` `Excel`
...
|---|---|
| [AWS Cost Optimization — Power BI](https://github.com/Nair-Shreyas/aws-cost-optimization-powerbi) | Interactive dashboard analyzing global EC2 pricing, cost anomalies, and savings opportunities |
...
*Open to Data Analyst, Data Scientist, and Business Analyst roles — always happy to chat.*
